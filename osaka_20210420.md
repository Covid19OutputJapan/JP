...
### 1. 大阪での「変異株感染力」分析
{: align="center"}
|[![Osaka_gradual_Y]({{ fig_loc }}VarInfection42_jp.png)]({{ fig_loc }}VarInfection42_jp.png)|

この図表のバックデータは[ここ]({{ fig_loc }}BackData_VarInfectionOsaka_42.xls)からダウンロードしてください。

出所: 著者達の計算による。<br>
{% include footnote_20210420.html content="82%"%}
<!-- 81.53% -->
