...
- （4月25日）4月25日からの緊急事態宣言： 「強い規制を短期間」が何故良いか[[ここをクリック]](./files/FujiiNakata_StrictAndShort_Slides_20210424.pdf){:target="_blank" rel="noopener"}

- （4月25日）第三回緊急事態宣言の解除基準分析[[ここをクリック]](./files/FujiiNakata_LiftingCriteria_Slides_20210424.pdf){:target="_blank" rel="noopener"}
