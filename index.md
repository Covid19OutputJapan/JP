...
{% include note.html content="今週のトレードオフカーブは先週のトレードオフカーブと比べてかなり下がっています。理由は二つあります。一つは1月18日－24日での新規感染者がモデルの予測よりも少し少なかったこと。もう一つは、高齢者がワクチンを接種することによる平均致死率の減少を予測に反映させたことです。両方とも同じくらいトレードオフカーブのシフトダウンに貢献しています。" %}
