...
{% include note.html content="「Covid-19と経済活動」最新分析のZoom解説と質疑応答。6月1日（火）午後6時から。ミーティングID: 857 0917 4188 。パスコード: 434588。一般の方々も歓迎です。"%}
[[ここをクリック]](https://u-tokyo-ac-jp.zoom.us/j/85709174188?pwd=cm5pTjJ0ZU9nelpWUkU3N2tyOGZLZz09){:target="_blank" rel="noopener"}

{% include note.html content="先週から重症患者数の見通しを追加しました。モデルの詳細は「重症患者数の見通し」をご覧ください。"%}
[[ここをクリック]](https://covid19outputjapan.github.io/JP/files/FujiiNakata_ICU_Slides_20210521.pdf){:target="_blank" rel="noopener"}

{% include note.html content="今週も、千葉・神奈川・埼玉県の更新はお休みします。"%}
